  <footer class="row bg-honeycomb">
      <div class="row mb-30 mt-30">
        <div class="col-sm-3 col-lg-2 col-lg-offset-1 text-left">
          <h3>Prudential</h3>
          <a href="/solusi"><p>Solusi</p></a>
          <a href="/profil"><p>Profil Kami</p></a>
        </div>
        <div class="col-sm-3 col-lg-2 text-left">
          <h3>Solusi</h3>
          <a href="/pendidikan"><p>Pendidikan</p></a>
          <a href="/kondisi-kritis"><p>Kondisi Kritis</p></a>
          <a href="/kesehatan"><p>Kesehatan</p></a>
          <a href="/proteksi"><p>Proteksi</p></a>
          <a href="/investasi"><p>Investasi</p></a>
        </div>
